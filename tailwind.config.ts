    ...
    extend: {
      ...
      keyframes: {
        ...
        "die-roll": {
          ...
          "60%": { transform: "rotateX(540deg) rotateY(270deg) rotateZ(180deg)" },
          "80%": { transform: "rotateX(720deg) rotateY(360deg) rotateZ(270deg)" },
      ...
      animation: {
        ...
        "die-roll": "die-roll 3s ease-out forwards",
